...
/*
 * File: GetOrderSummaryByPostalCode.js
 * Project: webapp-rrs
 ...
 */
const prepareEndPoint = () => RestEndpoints.CHECKOUT.GET_ORDER_SUMMARY_BY_POSTAL_CODE;
...
/**
 * GetOrderSummaryByPostalCode Class
 * @returns {*} GetOrderSummaryByPostalCode class instance
 */
class GetOrderSummaryByPostalCode extends ApiService.Service {
  constructor() {
    super({
...
export default new GetOrderSummaryByPostalCode();
