 ...
 * File: Storage.js
 * Project: webapp-rrs
 * Created Date: Monday, July 5th 2021, 3:28:29 pm
  ...
  if (key) {
    try {
      ...
      try {
        ...
        logger.error(`Error occurred while persisting value for key: "${key}"`, { key, value });
      }
    } catch (e) {
      logger.error(`Error occurred calling stringify value for key: "${key}"`, { key, value });
    }
  }
  return false;
};
